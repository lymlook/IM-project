      ...
      <template>
        <div style="width: 100%;margin-bottom: 20px;">
          ...
          >
            ...
            <el-table-column prop="platform" label="发布平台" width="100"></el-table-column>
...
export default {
  ...
  methods: {
    loadData() {
      ...
      var url = this.Api + "infoCenter/getInfoCenter";
      this.axios
      ...
      var platformUrl = this.Api + "platform/getPlatformInfo";
      this.axios
        .post(platformUrl, this.$qs.stringify())
        .then(response => {
          switch (response.data.code) {
            case 200:
      ...
      this.$refs.addForm.validate(valid => {
        ...
        if (valid) {
          ...
          this.$confirm("确认提交吗？", "提示", {}).then(() => {
            ...
            // 发保存请求
            var url = this.Api + "infoCenter/addInfoCenter"; // 新增
            this.$axios
      ...
      this.$refs.editForm.validate(valid => {
        if (valid) {
          ...
          this.$confirm("确认提交吗？", "提示", {}).then(() => {
            ...
            // 发保存请求
            var url = this.Api + "infoCenter/editInfoCenter";
            this.$axios
              .post(url, this.$qs.stringify(params))
              .then(response => {
    ...
    dictionaryDelete(index, row) {
      this.$confirm("确定删除吗？", "提示", {}).then(() => {
        ...
        var url = this.Api + "infoCenter/delInfoCenter"; // 删除
        this.$axios
    ...
    editState(id, status) {
      ...
      var url = this.Api + "infoCenter/editInfoCenterStatus";
      this.$axios
        .post(url, this.$qs.stringify(params))
        .then(response => {
          this.addLoading = false;
